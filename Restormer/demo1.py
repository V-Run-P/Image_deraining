...
def get_weights_and_parameters(task, parameters):
    if task == 'Motion_Deblurring':
        ...
        weights = "/home/mdl/shared/afs6372/rain_challenge/Restormer/experiments/Deraining_Restormer/models/net_g_30000.pth" # os.path.join('Deraining', 'pretrained_models', 'deraining.pth')
